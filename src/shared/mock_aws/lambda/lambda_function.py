...
def handle_submit(event: dict, path_params: dict) -> dict:
    ...
    mode = path_params.get('mode', 'centralized')
    ...
    # Se la coda è di tipo FIFO (First-In-First-Out), dobbiamo obbligatoriamente fornire i parametri MessageGroupId e MessageDeduplicationId univoci
