...
class InferenceOrchestratorFaultScenario(BaseTestScenario):
    ...
    def run(self) -> dict:
        ...
        print(f"\n--- [TEST] Failover dell'Orchestratore durante l'inferenza con Leader di Sistema: '{orch_leader.orchestrator_name}' ---")
        ...
        def kill_orchestrator():
            kill_after_seconds = ft_cfg.get("kill_orchestrator_after_seconds", 5)
